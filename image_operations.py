...
def create_text_to_image(text_parts, width=240, height=280, background_color=(0, 0, 0), font_paths=None, font_sizes=None, text_colors=None, output_file="air_temperature.png", drive_letter="D"):
...
def generate_image(city, temperature, drive_letter):
    text_parts = [
        "Location",
        city,
        "Temperature",
        f"{temperature}\u00b0C"  # Use Unicode escape sequence for degree symbol
    ]
    font_paths = ["MontserratBlack-3zOvZ.ttf"] * 4
    font_sizes = [20, 45, 20, 45] 
    text_colors = [(255, 255, 255), (255, 255, 255), (255, 255, 255), (0, 255, 0)]
